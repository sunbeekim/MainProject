...
public class ChatBotRuleDAOImpl implements ChatBotRuleDAO {
    ...
    private static final String NAMESPACE = "com.example.demo.mapper.ChatBotRuleMapper.";

    @Override
    public List<ChatBotRule> getRules(Integer roleId, String username) {
        return sqlSession.selectList(NAMESPACE + "getRules", Map.of(
            "roleId", roleId,
            "username", username
        ));
    }
    ...
    public ChatBotRule getRule(Long id, String username) {
        return sqlSession.selectOne(NAMESPACE + "getRule", Map.of(
            "id", id,
            "username", username
        ));
    }
    ...
    public void unapplyRule(Long id) {
        sqlSession.update(NAMESPACE + "unapplyRule", id);
    }
}